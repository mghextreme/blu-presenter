...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex flex-row justify-between items-center space-x-1.5 p-4", className)}
    {...props}
  />
))
...
export { Card, CardHeader, CardHeaderText, CardHeaderActions, CardFooter, CardTitle, CardDescription, CardContent }
